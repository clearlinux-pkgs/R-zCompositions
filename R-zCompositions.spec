...
Version  : 1.4.1
Release  : 57
URL      : https://cran.r-project.org/src/contrib/zCompositions_1.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/zCompositions_1.4.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692907360
